all: clean vcs
vcs:
	vcs -full64 -top glbl -top Test_RISCV_PROCESSOR -f flist.f -sverilog +incdir+./src/design/common +incdir+./src/design/newcache +vcs+fsdbon -fgp -debug_access+all  -kdb -lca -l vcs.log; ./simv -fgp:numcores=10 -l run.log 
vcs_xprop:
